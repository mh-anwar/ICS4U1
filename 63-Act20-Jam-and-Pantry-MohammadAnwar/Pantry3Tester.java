...
public class Pantry3Tester {
    public static void run() {
        ...
        // Create the pantry
        Pantry3 hubbardPantry = new Pantry3(strawberry, raspberry);
        ...
        Jam newCherryJam = new Jam("KelloCherry", "01112027", 1500);
        hubbardPantry.replace(newCherryJam, 1);

        spreadLeJam(hubbardPantry, 1, 320);
        spreadLeJam(hubbardPantry, 1);

        // Spread jam 2
        spreadLeJam(hubbardPantry, 2, 45);
        spreadLeJam(hubbardPantry, 2);

        // Spread jam 3
        spreadLeJam(hubbardPantry, 3, 12);
        ...
        // Create the pantry
        Pantry3 bucklandPantry = new Pantry3(apple);
        ...
        // Spread jam 2
        spreadLeJam(bucklandPantry, 2, 19);
        spreadLeJam(bucklandPantry, 2);

        // Spread jam 3
        bucklandPantry.replace(newCherryJam, 3);
        spreadLeJam(bucklandPantry, 3, 23);
        ...
        // Create the pantry
        Pantry3 chongPantry = new Pantry3(cherry, creamyCherry, bigCherry);
        System.out.println(chongPantry);

        // Spread jam 1
        spreadLeJam(chongPantry, 1);
        
        Jam newRamboFruit = new Jam("RamboFruit", "01112023", 1100);
        chongPantry.replace(newRamboFruit, 1);
        ...
        Jam newGongFruit = null;
        chongPantry.replace(newGongFruit, 3);
        spreadLeJam(chongPantry, 3);
    ...
    private static void spreadLeJam(Pantry3 pantry, int jamNum) {
    ...
    private static void spreadLeJam(Pantry3 pantry, int jamNum, int jamSpread) {
        Library.print("Spreading Jam " + jamNum);
        if (pantry.select(jamNum)) {
